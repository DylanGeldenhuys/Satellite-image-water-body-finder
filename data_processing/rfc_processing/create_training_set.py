        ...
        for y_origin in range(outer_padding, dataset.height - outer_padding, max_set_size):
            ...
            for x_origin in range(outer_padding, dataset.width - outer_padding, max_set_size):
                ...
                training_set['label'] = label_data[y_origin:y_origin +
                                                   window_height, x_origin:x_origin + window_width].flatten()
                ...
                final_training_set = final_training_set.append(
                    training_set[training_set.label == True].sample(frac=0.1))

                final_training_set.to_csv(training_output_directory.joinpath(
